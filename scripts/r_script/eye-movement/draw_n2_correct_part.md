...
# N2_V1_t :
# N2_V1_f :
# あぶない。gr.temp$Aに間違った変数が入るだっけだった。使ってないから問題ない。怖すぎ。
...
write.csv(gra, "/home/kishiyama/home/thesis/npi-thesis/result/main/csv/output4gra4n2.csv")
...
g.Combined.Region6000 <-
  ...
  scale_y_continuous(limits=c(0,0.65), name="Proportion of looks to target N2") +
...
dev.copy(pdf, "../pdf/n2_v1_part.pdf")
