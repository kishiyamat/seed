...
getwd()
write.csv(gra, "/home/kishiyama/home/thesis/npi-thesis/result/main/csv/output4gra4n1.csv")

# TODO: 最適なグラフ
# 適切な形式で保存

#グラフ作成の本番
d = data.frame(t = c( 3500 , 4100, 4700 , 5500),
          region = c( ""   , "V1", "POL", "N2"))
...
dev.copy(pdf, "../pdf/n1_v1_part.pdf")
