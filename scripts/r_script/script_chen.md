...
**Tobii TX300** + **Tobii Extension** で計測した眼球運動のデータを分析する
...
```python
getwd()
setwd("/home/kishiyama/home/thesis/npi-thesis/result/pilot")
```
...
for(file_name in data_list){
    ...
    fixations_in_trial <- trial[temp$GazeEventType == "Fixation",]
